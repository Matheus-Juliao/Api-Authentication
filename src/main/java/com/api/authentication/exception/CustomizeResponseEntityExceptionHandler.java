...
import com.api.authentication.exception.ExceptionResponseNotFoundAndUnauthorized;
...
public class CustomizeResponseEntityExceptionHandler {
    ...
    private @Nullable String setField(@NotNull Exception exception)  {
        ...
        if(exception.getMessage().compareTo(messageProperty.getProperty("error.token.invalid")) == 0) {
            return "token";
        }
